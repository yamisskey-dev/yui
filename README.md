...
``` json
{
  ...
  "geminiPostMode": "both",
  "autoNotePrompt": "Misskeyで投稿するような短い日記や独り言を280文字以内で作成してください。気分や感情を表現し、少し内省的な内容を含めてください。",
  "autoNoteIntervalMinutes": "360",
  "geminiAutoNoteProbability": "0.05",
  ...
  "aichatRandomTalkProbability": "0.15",
