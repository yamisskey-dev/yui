...
export const weather_phrases = {
  ...
  // === 拡張: 新しい天候・季節イベント ===
  typhoon: {
    situation: "台風が近づいてるみたい。外はすごい風と雨の音。ちょっと怖いけど、おうちで静かにしてる。",
    keywords: ["台風", "暴風雨", "窓がガタガタ", "停電しないかな", "備蓄", "外出注意", "非日常", "ニュースが気になる", "安全第一"]
  },
  heavy_snow: {
    situation: "今日は大雪。窓の外が真っ白で、静かで別世界みたい。",
    keywords: ["大雪", "積雪", "雪かき", "交通機関", "静寂", "雪だるま", "足跡", "寒い", "ホットドリンク"]
  },
  extreme_heat: {
    situation: "猛暑日で、外に出るだけで息苦しいくらい暑い。熱中症に気をつけてね。",
    keywords: ["猛暑日", "危険な暑さ", "水分補給", "日陰", "エアコン", "外出控えめ", "氷", "冷たいもの", "体調管理"]
  },
  cherry_blossom: {
    situation: "桜が満開で、街がピンク色に染まってる。お花見したい気分。",
    keywords: ["桜", "お花見", "春爛漫", "ピンク色", "写真撮りたい", "花びら", "春の香り", "新生活", "出会い"]
  },
  pollen: {
    situation: "今日は花粉が多いみたいで、くしゃみが止まらない…。外に出るのがちょっと憂鬱。",
    keywords: ["花粉症", "くしゃみ", "マスク", "目がかゆい", "鼻水", "春の悩み", "ティッシュ必須", "外出注意", "洗濯物"]
  },
  yellow_sand: {
    situation: "黄砂が飛んできて、空が少し霞んでる。喉や目に気をつけてね。",
    keywords: ["黄砂", "空が黄色い", "洗車", "マスク", "アレルギー", "視界不良", "春の風物詩", "外出注意", "健康管理"]
  },
  thunderstorm: {
    situation: "雷雨で空がピカピカ光ってる。大きな音にちょっとびっくり。",
    keywords: ["雷雨", "稲妻", "大きな音", "停電注意", "安全第一", "窓から観察", "非日常", "雨宿り", "ドキドキ"]
  },
  frost: {
    situation: "朝起きたら、外が霜で真っ白。空気がキーンと冷たい。",
    keywords: ["霜", "真っ白", "冷え込み", "冬の朝", "手がかじかむ", "吐く息が白い", "防寒", "静かな朝", "氷"]
  },
  rainbow: {
    situation: "雨上がりに虹が出てる！なんだかいいことありそうな気分。",
    keywords: ["虹", "雨上がり", "ラッキー", "空を見上げる", "写真撮りたい", "七色", "希望", "きれい", "一瞬の景色"]
  }
};
